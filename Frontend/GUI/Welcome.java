...
public class Welcome {
    public Welcome(){
        ...
        Welcome.setIconImage(new ImageIcon("C:\\Users\\sutti\\OneDrive\\Desktop\\Frontend\\Photo\\Logo\\LogoJFrame.png").getImage());
        Welcome.getContentPane().setBackground(new Color(255, 255, 204));
        Welcome.setLocationRelativeTo(null);
        

        ImageIcon icon = new ImageIcon("C:\\Users\\sutti\\OneDrive\\Desktop\\Frontend\\Photo\\Logo\\LogoWelcome.png");
