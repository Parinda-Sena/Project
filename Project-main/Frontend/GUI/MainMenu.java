...
public class MainMenu {
    ...
    public MainMenu() {
    // สร้าง AllFood / PricingService
    this.allFood = new AllFood();
    this.pricingService = new PricingService();

    // สร้าง cart ครั้งเดียวและเก็บใน static field
    if (MainMenu.cart == null) {
        MainMenu.cart = new FoodCart(allFood, pricingService);
    }
