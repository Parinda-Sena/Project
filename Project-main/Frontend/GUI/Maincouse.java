...
public class Maincouse {
    ...
    //  อ่านค่า ID ไฟล์ CSV
    private static final String FOOD_ID_omr = "09"; // ข้าวไข่เจียว
    private static final String FOOD_ID_sfr = "10"; // ข้าวผัดทะเล
    private static final String FOOD_ID_gcr = "11"; // แกงเขียวหวาน
    private static final String FOOD_ID_tyg = "12"; // ต้มยำกุ้ง
    private static final String FOOD_ID_pws = "13"; // ผัดกะเพราหมูสับ
    private static final String FOOD_ID_cws  = "14"; //ผัดกะเพราไก่
    private static final String FOOD_ID_crippy = "15"; // ผัดกะเพราหมูกรอบ
    private static final String FOOD_ID_tcc = "16"; // ปูผัดผงกะหรี่
    private static final String FOOD_ID_stirclams = "17"; //ผัดหอยลาย
    private static final String FOOD_ID_smg = "18"; // ผัดผักบุ้ง
    private static final String FOOD_ID_cmm  = "19"; // มัสมั่น
    private static final String FOOD_ID_pt  = "20"; // ผัดไท
    public Maincouse() {
    ...
    this.cart = MainMenu.cart;
        ...
        omrBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_omr, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        sfrBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_sfr, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        gcrBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_gcr, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_gcr, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        tygBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_tyg, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        pwsBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_pws, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        cwsBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_cws, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_cws, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        crippyBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_crippy, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_crippy, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        tccBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_tcc, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_tcc, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        stirclamsBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_stirclams, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_stirclams, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        smgBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_smg, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_smg, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        cmmBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_cmm, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_cmm, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        contentPanel.add(ptBTN);
         ...
         ptBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_pt, 1);
                    JOptionPane.showMessageDialog(Maincouse, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Product ID not found: " + FOOD_ID_pt, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Maincouse, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
