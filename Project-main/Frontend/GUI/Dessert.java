...
private final FoodCart cart; // ใช้ cart เดียวกับ MainMenu
    ...
    //  อ่านค่า ID ไฟล์ CSV
    private static final String FOOD_ID_choc = "21"; // ไอติมช็อกโกแลต
    private static final String FOOD_ID_donut = "22"; // โดนัท
    private static final String FOOD_ID_straw = "23"; // ไอติมสตรอว์เบอร์รี่
    private static final String FOOD_ID_cheese = "24"; // ชีสเค้ก
    private static final String FOOD_ID_lime = "25"; //  ไอติมมะนาว 
    private static final String FOOD_ID_honey  = "26"; //โทสต์
    private static final String FOOD_ID_vanila = "27"; // ไอติมวนิลา
    private static final String FOOD_ID_brown = "28"; // บราวนี่
    private static final String FOOD_ID_pancake= "29"; // แพนเค้ก
    private static final String FOOD_ID_strawcheese = "30"; //สตรอว์เบอร์รี่ชีสเค้ก
    private static final String FOOD_ID_mintchoc  = "31"; // ไอติมมิ้นช็อกโกแลต
    private static final String FOOD_ID_mango  = "32"; //ไอติมมะม่วง
    ...
    this.cart = MainMenu.cart;
        ...
        chocBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_choc, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_choc, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        contentPanel.add(donutBTN);
         ...
         donutBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_donut, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_donut, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        contentPanel.add(strawBTN);
         ...
         strawBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_straw, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_straw, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        contentPanel.add(cheeseBTN);
         ...
         cheeseBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_cheese, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_cheese, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        contentPanel.add(limeBTN);
         ...
         limeBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_lime, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_lime, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        contentPanel.add(honeyBTN);
         ...
         honeyBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_honey, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_honey, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        vanilaBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_vanila, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_vanila, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        brownBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_brown, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_brown, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        pancakeBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_pancake, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_pancake, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        strawcheeseBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_strawcheese, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_strawcheese, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        mintchocBTN.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_mintchoc, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_mintchoc, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        mangoBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    cart.addFood(FOOD_ID_mango, 1);
                    JOptionPane.showMessageDialog(Dessert, "Added to cart.");
                } catch (ProductNotFoundException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Product ID not found: " + FOOD_ID_mango, "Error", JOptionPane.ERROR_MESSAGE);
                } catch (InvalidOperationException ex) {
                    JOptionPane.showMessageDialog(Dessert, "Cannot add product: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
